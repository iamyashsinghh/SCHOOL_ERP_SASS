                    ...
                    <div style="width: {{ Arr::get($layout, 'box_width') }}; border: 1px solid black;">
                        ...
                        <div class="{{ Arr::get($layout, 'watermark') ? 'watermark-container' : '' }}">
                            ...
                            <table class="mt-2 inner-table cellpadding" width="100%">
                                ...
                                <tr>
                                    <td>{{ trans('academic.course.props.term') }}</td>
                                    <td class="text-right">{{ $student->course_term }}
                                    </td>
                                    <td>{{ trans('student.enrollment_type.enrollment_type') }}</td>
                                    <td class="text-right">{{ $student->enrollment_type_name }}</td>
                                </tr>
                            </table>
                            ...
                            <table class="mt-4 inner-table font-85pc" width="100%">
                                @foreach ($student->summaryRows as $row)
                                    <tr>
                                        @foreach ($row as $cell)
                                            <td colspan="{{ Arr::get($cell, 'colspan', 1) }}"
                                                @class([
                            ...
                            <p class="ml-4">{{ trans('exam.result_date') }}:
                                {{ \Cal::date(Arr::get($params, 'result_date'))->formatted }}</p>
