    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
            ...
            <div class="mt-4 flex items-center text-sm">
                <span class="text-emerald-600 font-medium">{{ $activeSchools }} active</span>
                <span class="text-gray-300 mx-2">•</span>
                <span class="text-red-500 font-medium">{{ $suspendedSchools }} suspended</span>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-1">{{ $totalMinistries }}</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-1">{{ $totalProvinces }}</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-1">{{ $totalSubDivisions }}</p>
                </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50/50">
                        <td class="py-3 font-medium text-gray-900">{{ $school->name }}</td>
                        <td class="py-3 text-gray-600">{{ $school->subDivision?->name ?? '-' }}</td>
                        <td class="py-3"><span class="text-indigo-600">{{ $school->domains->first()?->domain ?? '-' }}</span></td>
                        <td class="py-3">
                        ...
                        <td class="py-3 text-gray-500">{{ $school->created_at->diffForHumans() }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
