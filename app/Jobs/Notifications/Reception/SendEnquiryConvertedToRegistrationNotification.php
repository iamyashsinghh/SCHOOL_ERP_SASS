...
class SendEnquiryConvertedToRegistrationNotification implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $templateCode = 'enquiry-converted-to-registration';
        ...
        $enquiry = Enquiry::query()
            ->with('stage', 'type', 'source', 'employee.contact')
            ->byTeam($teamId)
            ->findOrFail(Arr::get($this->params, 'enquiry_id'));

        $user = $enquiry->employee?->contact?->user;
