...
class SendRegistrationConvertedToAdmissionNotification implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $templateCode = 'registration-converted-to-admission';
        ...
        $user = $registration->employee?->contact?->user;
