...
class SendOnlineRegistrationFeePaymentFailedNotification implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $templateCode = 'online-registration-fee-payment-failed';
        ...
        $variables = [
            ...
            'payment_datetime' => Arr::get($this->params, 'payment_datetime'),
