...
class SendOnlineRegistrationFeePaymentConfirmedNotification implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $templateCode = 'online-registration-fee-payment-confirmed';
        ...
        $variables = [
            ...
            'payment_datetime' => $transaction->processed_at->formatted,
