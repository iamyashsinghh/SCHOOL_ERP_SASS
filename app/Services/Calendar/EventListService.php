...
class EventListService extends ListGenerator
{
    ...
    public function getHeaders(): array
    {
        $headers = [
            [
                'key' => 'codeNumber',
                'label' => trans('calendar.event.props.code_number'),
                'sortable' => false,
                'visibility' => true,
            ],
            [
                'key' => 'type',
                'label' => trans('calendar.event.props.type'),
            ...
            [
                'key' => 'title',
                'label' => trans('calendar.event.props.title'),
                'print_label' => 'title',
            ...
            [
                'key' => 'startDate',
                'label' => trans('calendar.event.props.start_date'),
            ...
            [
                'key' => 'endDate',
                'label' => trans('calendar.event.props.end_date'),
            ...
            [
                'key' => 'audience',
                'label' => trans('calendar.event.props.audience'),
                'type' => 'array',
            ...
            [
                'key' => 'incharge',
                'label' => trans('employee.incharge.incharge'),
    ...
    public function filter(Request $request): Builder
    {
        ...
        return Event::query()
            ...
            ->when($request->query('for') == 'is_public', function ($q) {
                $q->where('is_public', true);
            })
            ->when($request->query('for') == 'for_alumni', function ($q) {
                $q->where('meta->for_alumni', true);
            })
            ->filter([
    ...
    {
        return EventResource::collection($this->filter($request)
