...
class DialogueListService extends ListGenerator
{
    ...
    public function getHeaders(): array
    {
        $headers = [
            [
                'key' => 'title',
                'label' => trans('employee.dialogue.props.title'),
                'sortable' => false,
                'visibility' => true,
            ],
            [
                'key' => 'category',
                'label' => trans('employee.dialogue_category.dialogue_category'),
            ...
            [
                'key' => 'date',
                'label' => trans('employee.dialogue.props.date'),
    ...
    {
        return DialogueResource::collection($this->filter($request, $employee)
