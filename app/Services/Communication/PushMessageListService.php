...
class PushMessageListService extends ListGenerator
{
    ...
    public function getHeaders(): array
    {
        $headers = [
            [
                'key' => 'subject',
                'label' => trans('communication.push_message.props.subject'),
                'print_label' => 'subject',
                'sortable' => true,
                'visibility' => true,
            ],
            [
                'key' => 'audience',
                'label' => trans('communication.push_message.props.audience'),
                'type' => 'array',
            ...
            [
                'key' => 'recipientCount',
                'label' => trans('communication.push_message.props.recipient'),
    ...
    {
        return PushMessageResource::collection($this->filter($request)
