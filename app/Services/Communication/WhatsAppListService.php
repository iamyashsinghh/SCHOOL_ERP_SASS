...
class WhatsAppListService extends ListGenerator
{
    ...
    public function getHeaders(): array
    {
        $headers = [
            [
                'key' => 'subject',
                'label' => trans('communication.whatsapp.props.subject'),
                'print_label' => 'subject',
                'sortable' => true,
                'visibility' => true,
            ],
            [
                'key' => 'audience',
                'label' => trans('communication.whatsapp.props.audience'),
                'type' => 'array',
            ...
            [
                'key' => 'recipientCount',
                'label' => trans('communication.whatsapp.props.recipient'),
    ...
    {
        return WhatsAppResource::collection($this->filter($request)
