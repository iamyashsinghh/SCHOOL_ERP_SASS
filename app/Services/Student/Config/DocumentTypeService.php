...
class DocumentTypeService
{
    ...
    private function formatParams(Request $request, ?Option $documentType = null): array
    {
        $formatted = [
            ...
            'type' => OptionType::STUDENT_DOCUMENT_TYPE->value,
    ...
    public function deletable(Request $request, Option $documentType): void
    {
        ...
        if ($existingDocuments) {
            throw ValidationException::withMessages(['message' => trans('global.associated_with_dependency', ['attribute' => trans('student.document_type.document_type'), 'dependency' => trans('student.document.document')])]);
        }
    }
}
