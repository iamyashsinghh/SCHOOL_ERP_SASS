...
class ContactPolicy
{
    ...
    private function validateTeam(User $user, Contact $contact)
    {
    ...
    {
        return $user->canAny(['contact:create', 'contact:edit']);
    }
    ...
    {
        if (! $this->validateTeam($user, $contact)) {
            return false;
        }
